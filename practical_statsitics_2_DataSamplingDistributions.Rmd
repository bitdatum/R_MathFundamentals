...
loans_income <- read.csv(file.path(PSDS_PATH, 'R\\R_MathFundamentals\\data', 'loans_income.csv'))
loans_income <- loans_income[, 1]   # convert data frame to vector
sp500_px <- read.csv(file.path(PSDS_PATH,'R\\R_MathFundamentals\\data', 'sp500_data.csv.gz'), row.names = 1)
...
## 2.1. Sampling Distribution of a Statistic
...
## 2.7. Poisson and Related Distribution
